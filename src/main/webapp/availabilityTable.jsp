...
<table class="table table-sm text-center">
  ...
  <tbody>
    ...
    <tr>
      <td id="first-slot" onclick="toggleTile(this)" data-utc="${list.get(0).get(0).utcEncoding()}" class="${list.get(0).get(0).selected() ? 'table-success' : ''}">
        ${list.get(0).get(0).time()}
      </td>
      <c:forEach var = "i" begin = "1" end = "6">
        <td onclick="toggleTile(this)" data-utc="${list.get(i).get(0).utcEncoding()}" class="${list.get(i).get(0).selected() ? 'table-success' : ''}">
    ...
    <tr>
      <c:forEach var = "i" begin = "0" end = "5">
        <td onclick="toggleTile(this)" data-utc="${list.get(i).get(list.get(0).size() - 1).utcEncoding()}" class="${list.get(i).get(list.get(0).size() - 1).selected() ? 'table-success' : ''}">
          ${list.get(i).get(list.get(0).size() - 1).time()}
        </td>
      </c:forEach>
      <td id="last-slot" onclick="toggleTile(this)" data-utc="${list.get(6).get(list.get(0).size() - 1).utcEncoding()}" class="${list.get(6).get(list.get(0).size() - 1).selected() ? 'table-success' : ''}">
