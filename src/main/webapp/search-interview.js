...
function selectInterview(interviewer) {
  if (confirm(
    ...
    alert(
      ...
      `information.`);
     const request = new Request(`/scheduled-interviews?startTime=2020-07-31T18:30:10Z&endTime=2020-07-13T19:30:10Z&interviewer=${interviewer.getAttribute('data-email')}&interviewee=	120316124221414916520`, {	
      method: 'POST'	
    }); 	
    fetch(request)	
      .then(response => {	
