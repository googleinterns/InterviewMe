...
function selectInterview(interviewer) {
  if (confirm(
    ...
    alert(
      ...
      `information.`);
      const request = new Request(`/scheduled-interviews?startTime=2020-07-21T18:30:10Z&endTime=2020-07-13T19:30:10Z&interviewee=120316124221414916520&interviewer=${interviewer.getAttribute('data-email')}`, {		
      method: 'POST'		
    }); 		
    fetch(request)		
      .then(response => {		
