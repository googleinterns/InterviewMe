...
<html>
  ...
  <body onload="onAvailabilityLoad()">
    <div id="content">
      ...
      <!-- This table-container is filled with a JSP page onload.-->
      <div id="table-container">
        <!-- This is a place holder for when the page is slow to load.-->
        <p class="text-center">Loading your interview availability...</p>
      </div>
      <!-- TODO: Implement an onclick function called updateAvailability() that will process whether or not a time slot is
        selected and use the UTC Encoding to send relevant requests to the backend.-->
