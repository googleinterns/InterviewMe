...
public class CalendarAccess {
  ...
  // TODO: remember to write tests in the code that calls CalendarAccess() that handle what happens per each exception
  public CalendarAccess() throws GeneralSecurityException, IOException, URISyntaxException, Exception {
